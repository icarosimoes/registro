...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "suite_id",
            sa.Integer,
            sa.ForeignKey("check_suites.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "suite_id",
            sa.Integer,
            sa.ForeignKey("inspection_suites.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "inspection_suite_id",
            sa.Integer,
            sa.ForeignKey("inspection_suites.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column(
            "inspector_user_id",
    ...
    op.create_index(
        "ix_apartment_inspections_type", "apartment_inspections", ["company_id", "inspection_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "inspection_id",
            sa.Integer,
            sa.ForeignKey("apartment_inspections.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "suite_item_id",
            sa.Integer,
            sa.ForeignKey("inspection_suite_items.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_apt_inspection_items_inspection", "apartment_inspection_items", ["inspection_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "report_id",
            sa.Integer,
            sa.ForeignKey("audit_reports.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "diary_id",
            sa.Integer,
            sa.ForeignKey("work_diaries.id", ondelete="CASCADE"),
            nullable=False,
        ),

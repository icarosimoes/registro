...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "work_order_id", sa.Integer, sa.ForeignKey("work_orders.id", ondelete="SET NULL")
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "shift_report_id", sa.Integer, sa.ForeignKey("shift_reports.id", ondelete="SET NULL")
        ),
        ...
        sa.Column(
            "resolved_by_user_id", sa.Integer, sa.ForeignKey("users.id", ondelete="SET NULL")
        ),
    ...
    op.create_index(
        "ix_shift_handoffs_company_date", "shift_handoffs", ["company_id", "target_date"]
    )

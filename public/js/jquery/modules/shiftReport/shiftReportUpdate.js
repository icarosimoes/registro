...
/***/ "./resources/js/Jquery/modules/shiftReport/shiftReportUpdate.js":
/*!**********************************************************************!*\
  !*** ./resources/js/Jquery/modules/shiftReport/shiftReportUpdate.js ***!
  \**********************************************************************/
...
$(function () {
  ...
  $("#addFrequency").click(function () {
    var html = "<tr class='itemFrequency'>" + "<td><input id='frequency_employee[]' name='frequency_employee[]' type='text' class='form-control form-control-sm' required></td>" + "<td><input id='frequency_occupation[]' name='frequency_occupation[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemFrequency'><i class='fas fa-trash'></i></a>" + "</td>" + "</tr>";
  ...
  $.each(JSON.parse(shiftReport_frequency), function (index, value) {
    var html = "<tr class='itemFrequency'>" + "<td><input id='frequency_employee[]' value='" + value.employee + "' name='frequency_employee[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='frequency_id[]' id='frequency_id[]' value='" + value.id + "'>" + "<td><input id='frequency_occupation[]' value='" + value.occupation + "' name='frequency_occupation[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + // "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemFrequency'><i class='fas fa-trash'></i></a>" +
    "</td>" + "</tr>";
    addItem(html, "#appendFrequency", ".removeItemFrequency", ".itemFrequency");
  });
  $("#addExtra").click(function () {
    var html = "<tr class='itemExtra'>" + "<td><input id='extra_extrawork[]' name='extra_extrawork[]' type='text' class='form-control form-control-sm' required></td>" + "<td><input id='extra_reasons[]' name='extra_reasons[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemExtra'><i class='fas fa-trash'></i></a>" + "</td>" + "</tr>";
  ...
  $.each(JSON.parse(shiftReport_extra), function (index, value) {
    var html = "<tr class='itemExtra'>" + "<td><input id='extra_extrawork[]' value='" + value.extrawork + "' name='extra_extrawork[]' type='text' class='form-control form-control-sm' required></td>" + "<td><input id='extra_reasons[]' value='" + value.reasons + "' name='extra_reasons[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='extra_id[]' id='extra_id[]' value='" + value.id + "'>" + "<td>" + // "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemExtra'><i class='fas fa-trash'></i></a>" +
    "</td>" + "</tr>";
    addItem(html, "#addItemExtra", ".removeItemExtra", ".itemExtra");
  });
  var countMaintenance = 0;
  $("#addMaintenance").click(function () {
    var html = "<tr class='itemMaintenance-" + countMaintenance + "'>" + "<td><input  id='maintenence_uh[]' name='maintenence_uh[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='id_oc_maintenence[]' id='id_oc_maintenence-" + countMaintenance + "' value=''>" + "<td>" + "<select id='maintenence_status[]' name='maintenence_status[]' class='form-control form-control-sm' required>" + "<option value='BLOQUEADO'>BLOQUEADO</option>" + "<option value='DISPONÍVEL'>DISPONÍVEL</option>" + "</select>" + "</td>" + "<td><input id='maintenence_reason[]' name='maintenence_reason[]' type='text' class='form-control form-control-sm' required></td>" + "<td><input id='maintenence_providence[]' name='maintenence_providence[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemMaintenance'><i class='fas fa-trash'></i></a> " + "<a href='#' data-toggle='modal' data-target='#ModalSelectOcurrence' class='btn btn-sm btn-default searchItemOccurenceMaintenence'><i class='fas fa-filter'></i></a> " + "<small id='showIdOccurenceMaintenence-" + countMaintenance + "' class='badge d-none badge-success codeOccurenceMaintenence-" + countMaintenance + "'><i class='far fa-registered'></i></small>" + "</td>" + "</tr>";
  ...
  $.each(JSON.parse(shiftReport_maintenence), function (index, value) {
    var html = "<tr class='itemMaintenance'>" + "<td><input  id='maintenence_uh[]' value='" + value.uh + "' name='maintenence_uh[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='maintenence_id[]' id='maintenence_id[]' value='" + value.id + "'>" + "<td>" + "<select id='maintenence_status[]' value='" + value.status + "' name='maintenence_status[]' class='form-control form-control-sm' required>" + "<option value='BLOQUEADO'>BLOQUEADO</option>" + "<option value='DISPONÍVEL'>DISPONÍVEL</option>" + "</select>" + "</td>" + "<td><input id='maintenence_reason[]' value='" + value.reason + "' name='maintenence_reason[]' type='text' class='form-control form-control-sm' required></td>" + "<td><input id='maintenence_providence[]' value='" + value.providence + "' name='maintenence_providence[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + // "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemMaintenance'><i class='fas fa-trash'></i></a> " +
    ...
    "<small id='showIdOccurenceMaintenence' class='badge d-none badge-success codeOccurenceMaintenence'><i class='far fa-registered'></i> " + value.occurrences_id + "</small>" + "</td>" + "</tr>";
    addItem(html, "#addItemMaintenance", ".removeItemMaintenance", ".itemMaintenance");
  });
  var countCustomerComplaint = 0;
  $("#btnAddCustomerComplaint").click(function () {
    var html = "<tr class='itemCustomerComplaint-" + countCustomerComplaint + "'>" + "<td><input id='customer_comp_problem[]' name='customer_comp_problem[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='id_oc_customer_comp[]' id='id_oc_customer_comp-" + countCustomerComplaint + "' value=''>" + "<td><input id='customer_comp_providence[]' name='customer_comp_providence[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemCustomerComplaint'><i class='fas fa-trash'></i></a> " + "<a href='#' data-toggle='modal' data-target='#ModalSelectOcurrence' class='btn btn-sm btn-default searchItemOccurenceCustomerComp'><i class='fas fa-filter'></i></a> " + "<small id='showIdOccurenceCustomerComp-" + countCustomerComplaint + "' class='badge d-none badge-success codeOccurenceCustomerComp-" + countCustomerComplaint + "'></small>" + "</td>" + "</tr>";
  ...
  $.each(JSON.parse(shiftReport_customer_comp), function (index, value) {
    var html = "<tr class='itemCustomerComplaint'>" + "<td><input id='customer_comp_problem[]' value='" + value.problem + "' name='customer_comp_problem[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='customer_comp_id[]' id='customer_comp_id[]' value='" + value.id + "'>" + "<td><input id='customer_comp_providence[]' value='" + value.providence + "' name='customer_comp_providence[]' type='text' class='form-control form-control-sm' required></td>" + "<td>" + // "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemCustomerComplaint'><i class='fas fa-trash'></i></a> " +
    ...
    "<small id='showIdOccurenceCustomerComp' class='badge d-none badge-success codeOccurenceCustomerComp'>" + value.occurrences_id + "</small>" + "</td>" + "</tr>";
    addItem(html, "#addCustomerComplaint", ".removeItemCustomerComplaint", ".itemCustomerComplaint");
  });
  var countComments = 0;
  $("#btnAddComments").click(function () {
    var html = "<tr class='itemComments-" + countComments + "'>" + "<td><input id='comments[]' name='comments[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='id_oc_comments[]' id='id_oc_comments-" + countComments + "' value=''>" + "<td>" + "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemComments'><i class='fas fa-trash'></i></a> " + "<a href='#' data-toggle='modal' data-target='#ModalSelectOcurrence' class='btn btn-sm btn-default searchItemOccurenceComments'><i class='fas fa-filter'></i></a> " + "<small id='showIdOccurenceComments-" + countComments + "' class='badge d-none badge-success codeOccurenceComments-" + countComments + "'></small>" + "</td>" + "</tr>";
  ...
  $.each(JSON.parse(shiftReport_comments), function (index, value) {
    var html = "<tr class='itemComments'>" + "<td><input id='comments[]' value='" + value.comments + "' name='comments[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='comments_id[]' id='comments_id[]' value='" + value.id + "'>" + "<td>" + //"<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemComments'><i class='fas fa-trash'></i></a> " +
    ...
    "<small id='showIdOccurenceComments' class='badge d-none badge-success codeOccurenceComments'>" + value.occurrences_id + "</small>" + "</td>" + "</tr>";
    addItem(html, "#addComments", ".removeItemComments", ".itemComments");
  ...
  $('form[name="formShiftReportEdit"]').submit(function (event) {
    ...
    form_data.append('outputQuantity', $('#outputQuantity').val()); //form_data.append('photo', $('#photo').prop('files')[0]);
    //VALIDAÇÕES
    ...
    form_data.append('frequency_id[]', frequency_id); //EXTRA
    ...
    form_data.append('extra_id[]', extra_id); //MANUTENÇÃO
    ...
    form_data.append('maintenence_id[]', maintenence_id); //RECLAMAÇÃO DO CLIENTE
    ...
    form_data.append('customer_comp_id[]', customer_comp_id); // //OBSERVAÇÕES
...
/***/ 12:
/*!****************************************************************************!*\
  !*** multi ./resources/js/Jquery/modules/shiftReport/shiftReportUpdate.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/aero/public_html/aero/resources/js/Jquery/modules/shiftReport/shiftReportUpdate.js */"./resources/js/Jquery/modules/shiftReport/shiftReportUpdate.js");

              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-3">
                    ...
                    <input {{ $meeting->start_meeting == null ? '' : 'readonly' }} value="{{ $meeting->datetime }}"
                      id="datetime" class="form-control" type="datetime-local" required>
                  </div>
                  <div class="col-3">
                  ...
                  <div class="col-3">
                    ...
                    <select name="" id="status" class="form-control" data-value="{{ $meeting->status }}">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="card-body">
                    <div class="row" id="registered_users">
                      ...
                      <input type="hidden" id="meeting_registered_participants" name="meeting_registered_participants"
                ...
                <div class="col-sm-6">
                  ...
                  <div class="card-body">
                    <div class="row" id="invited_users">
                      <input type="hidden" id="meeting_invited_participants" name="meeting_invited_participants"
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col text-center">
                    <button type="button" {{ $meeting->start_meeting == null ? '' : 'disabled' }}
                        ...
                        <div class="col">
                          ...
                          <div class="input-group">
                            ...
                            <div class="input-group-append">
                              <button type="button" data-id="{{ $subjects->id }}"
                                class="btn btn-sm btn-secondary btn_attach_subject">
                        ...
                        <div class="row mt-3">
                          <div class="col">
                            ...
                            <div class="input-group">
                              ...
                              <div class="input-group-append">
                                <button data-id="{{ $subjects->id }}" class="btn btn-danger btn-sm trash_subject"
                                  type="button"><i class="fas fa-trash"></i></button>
                                  <button type="button" data-id="{{ $subjects->id }}"
                                class="btn btn-sm btn-secondary btn_attach_new_subject">
                                <i class="fas fa-paperclip"></i>
                              </button>
                              </div>
                            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <label>Usuário</label>
              <select class="form-control select2" id="userRegistered" name="userRegistered" style="width: 100%;">
...
<div class="modal fade" id="export-pdf" tabindex="-1" role="dialog" aria-labelledby="export-pdf"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="far fa-times-circle"></i>
          Sair</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="origin_attach_subject_id">
        <div class="form-group">
...
<div class="modal" id="confirm_delete_attach" tabindex="-1" role="dialog" aria-labelledby="export-pdf"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id=""><i class="far fa-times-circle"></i>
          Sair</button>

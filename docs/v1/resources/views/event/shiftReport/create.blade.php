            ...
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('shiftreport.list') }}">Lista de Relatório de
                            Turno</a></li>
                    <li class="breadcrumb-item active">Novo Relatório de Turno</li>
                </ol>
            </div>
            <div class="col-md-12">
                <div class="container-fluid">
                    ...
                    {{-- <div class="row"> --}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="datetime-local"
                                                        value="{{ date('d/m/Y H:i:s') }}" name="beginning" id="beginning" required>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="datetime-local"
                                                        value="{{ date('d/m/Y H:i:s') }}" name="end" id="end" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="Name">Retorno de clientes:</label>
                                                    <input type="number" class="form-control" name="return_of_customers"
                        ...
                        {{-- <div class="modal fade" id="ModalNewOcurrence" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="buttonNewOccurrence" name="buttonNewOccurrence"
                                            class="btn btn-primary float-md-right buttonOccurrence"><i class="fas fa-hand-pointer"></i> Selecionar</button>
                                    </div>
                                </div>
                            </div>

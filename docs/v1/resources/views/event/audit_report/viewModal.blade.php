...
<div class="col-md-12">
  <div class="card card-secondary card-outline">
    <div class="card-header">
      ...
      <a href="{{ route('shiftreport.export_excel', $data->id) }}" type="button" class="btn btn-sm btn-warning"
        title="Salvar">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" type="datetime-local"
              value="{{ (new DateTime($data->beginning))->format('Y-m-d\TH:i:s') }}" name="beginning" id="beginning"
              required>
          ...
          <div class="form-group">
            ...
            <input type="number" value="{{ $data->inputQuantity }}" class="form-control" name="inputQuantity"
              id="inputQuantity" placeholder="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" value="{{ $data->return_of_customers }}" class="form-control"
              name="return_of_customers" id="return_of_customers" placeholder="" required>
          </div>
          <div class="form-group">
            <label for="Name">Quantidade de Saída:</label>
            <input type="number" value="{{ $data->outputQuantity }}" class="form-control" name="outputQuantity"
              id="outputQuantity" placeholder="" required>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <table name="DataTableUser" id="DataTableUser" class="table table-sm tablenotstyle">
          ...
          <tbody id="appendFrequency">
            <input type="hidden" name="shiftReport_frequency" id="shiftReport_frequency"
              value="{{ $shiftReport_frequency }}">
          </tbody>
        </table>
      </div>
    </div>
      ...
      <div class="row">
        <table name="DataTableUser" id="DataTableUser" class="table table-sm tablenotstyle">
          ...
          <tbody id="addItemMaintenance">
            <input type="hidden" name="shiftReport_maintenence" id="shiftReport_maintenence"
              value="{{ $shiftReport_maintenence }}">
      ...
      <div class="row">
        <table name="DataTableUser" id="DataTableUser" class="table table-sm tablenotstyle">
          ...
          <tbody id="addCustomerComplaint">
            <input type="hidden" name="shiftReport_customer_comp" id="shiftReport_customer_comp"
              value="{{ $shiftReport_customer_comp }}">
      ...
      <div class="row">
        <table name="DataTableUser" id="DataTableUser" class="table table-sm tablenotstyle">
          ...
          <tbody id="addComments">
            <input type="hidden" name="shiftReport_comments" id="shiftReport_comments"
              value="{{ $shiftReport_comments }}">

                    ...
                    <div class="col-md-12">
                        <div class="card card-secondary card-outline">
                            <div class="card-header">
                                ...
                                <input type="text" id="last_inspection_suite_items" value="{{ $last_inspection_suite_items }}">
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <table style="font-size: 13px" class="table table-sm ">
                                        ...
                                        <tbody>
                                            <tr>
                                              {{-- <input style="border:none;width:500px" type="text"> --}}
                                                <td>1</td>
                                                <td><textarea  style="border:none;resize:none"  cols="60" rows="2"></textarea></td>
                                                <td>

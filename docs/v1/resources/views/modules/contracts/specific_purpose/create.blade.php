        ...
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Novo Contrato Propósito Específico</li>
                ...
                <div class="container-fluid">
                    <div class="card card-secondary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Novo Contrato Propósito Específico</h3>
                        </div>
                        <form name="formContractSpecificPurpose" id="formContractSpecificPurpose" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
...
@section('plugins.scriptCreateContractSpecificPurpose', true) 
@endsection

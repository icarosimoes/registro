        ...
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Contratos Recorrentes</li>
                </ol>
            </div>
            <div class="col-md-12">
                <div class="card card-secondary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">Contratos Recorrentes</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <a type="button" href="{{ route('create.contract.recurrent') }}" data-toggle="tooltip"
                                    ...
                                    <form name="formContractFileDownload" id="formContractFileDownload" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" name="contract_recurrents_id" id="contract_recurrents_id">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                @can('checkRouters', $route = 'view.contract.recurrent')
                                                    <a href="{{ route('view.contract.recurrent', ['id' => $item->id]) }}"
                                                ...
                                                <a data-id="{{ $item->id }}" class="btn btn-default md" data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    @can('checkRouters', $route = 'edit.contract.recurrent')
                                                        <a href="{{ route('edit.contract.recurrent', ['id' => $item->id]) }}"
                                                            class="btn btn-default" data-toggle="tooltip" data-placement="top"
                                                            title="Editar Contratos Recorrentes"><i class="far fa-edit"></i></a>
                                                    @endcan
                                                    @can('checkRouters', $route = 'list.contract.recurrent.instament')
                                                        <a href="{{ route('list.contract.recurrent.instament', ['id' => $item->id]) }}"
...
@section('plugins.createContractFiles', true)
@endsection

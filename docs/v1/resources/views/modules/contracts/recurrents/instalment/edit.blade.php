            ...
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="{{ route('list.contract.recurrent.instament', ['id' => $contract->id]) }}">Lista de
                            Contratos Recorrentes</a></li>
                        ...
                        <div class="card-body">
                            <form name="formNewExpenditureEdit" id="formNewExpenditureEdit" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="contract_recurrents_id" id="contract_recurrents_id"
                                        value="{{ $contract->id }}">
...
@section('plugins.scriptUpdateContractInstallments', true)
@endsection

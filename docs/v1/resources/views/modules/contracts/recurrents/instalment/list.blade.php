                        ...
                        <div class="row">
                            <div class="col">
                                <h3 class="card-title"><b>Fornecedor:
                                    </b>{{ $contractRecurrent['suppliers']->fantasy_name }}</h3>
                            </div>
                            <div class="col">
                                <h3 class="card-title"><b>ID: </b>{{ $contractRecurrent->id }}</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <h3 class="card-title"><b>Centro de Custo:
                                    </b>{{ $contractRecurrent['chart_of_accounts']->name }}</h3>
                            </div>
                            <div class="col">
                                <h3 class="card-title"><b>Plano de Contas:
                                    </b>{{ $contractRecurrent['cost_centers']->name }}</h3>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <a type="button"
                                        href="{{ route('create.contract.recurrent.instament', ['id' => $contractRecurrent->id]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('edit.contract.recurrent.instament', ['contract_id' => $contractRecurrent->id, 'id' => $item->id]) }}"
                                                    class="btn btn-default" data-toggle="tooltip" data-placement="top"
                                                    title="Editar"><i class="far fa-edit"></i></a>
                                                <a href="{{ route('create.contract.recurrent.instament.commitment', ['contract_id' => $contractRecurrent->id,'id' => $item->id]) }}"
                                                    class="btn btn-default" data-toggle="tooltip" data-placement="top"
                                                ...
                                                <a class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top"
                                                    title="Excluir"
                                                    href="{{ route('delete.contract.recurrent.installments', ['id' => $item->id, 'contract_id' => $contractRecurrent->id]) }}"><i

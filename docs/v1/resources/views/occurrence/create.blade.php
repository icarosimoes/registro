              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="deadline" id="deadline" placeholder="" required>
                    </div>
                  </div>
                  <div class="col">
                    <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="select2-purple">
                    <select class="select2" id="participants" name="participants" multiple="multiple"
                      data-placeholder="Selecione 1 ou mais participantes" data-dropdown-css-class="select2-purple"
                      style="width: 100%;">
                      @foreach ($users as $user)
                        <option value="{{ $user->id }}">{{ $user->name }}</option>
                      @endforeach

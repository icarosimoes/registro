                        ...
                        <div class="card card-secondary card-outline">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled class="form-control" value="{{ $data->title }}"
                                                name="title" id="title" placeholder="" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-append">
                                                    <a target="_blank" href="{{ route('occurrence.edit.download_file',$data->id) }}" class="btn btn-secondary {{ $data->file ?'':'disabled' }}"><i
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="evolution" id="evolution" cols="30" rows="5"></textarea>
                                </div> --}}
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            <label for="Name">Status</label>
                                            <select disabled class="form-control select2" name="status" id="status" required>
                                                @if ($data->status == 1)
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input disabled type="date" class="form-control" value="{{ $data->deadline }}"
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <select disabled class="form-control select2" name="receiver" id="receiver"
                                                required>
                                                <option selected value="{{ $receiver->id }}">{{ $receiver->name }}
                                                </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-purple">
                                        <select disabled class="select2" id="participants" name="participants"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea disabled class="form-control" name="comments" id="comments" cols="30" rows="5">{{ $data->comments }}</textarea>
                                </div>

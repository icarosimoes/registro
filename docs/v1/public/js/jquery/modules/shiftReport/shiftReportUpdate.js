...
$(function () {
  ...
  $("#addFrequency").click(function () {
    var html = "<tr class='itemFrequency'>" + "<td><input id='frequency_employee[]' name='frequency_employee[]' type='text' class='form-control form-control-sm' required></td>" + "<td> <select class='select2'></select> </td>" +
    // "<td><input id='frequency_occupation[]' name='frequency_occupation[]' type='text' class='form-control form-control-sm' required></td>" +
    "<td>" + "<a href='#' data-toggle='tooltip' data-placement='top' title='Excluir' class='btn btn-sm btn-default removeItemFrequency'><i class='fas fa-trash'></i></a>" + "</td>" + "</tr>";
  ...
  $.each(JSON.parse(shiftReport_frequency), function (index, value) {
    var html = "<tr class='itemFrequency'>" + "<td><input id='frequency_employee[]' value='" + value.employee + "' name='frequency_employee[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='frequency_id[]' id='frequency_id[]' value='" + value.id + "'>" + "<td><select class='form-control function' name='frequency_occupation[]'>" + "<option value='" + value.func.id + "' >" + value.func.id + " - " + value.func.name + "</option>" + "</select></td>" +
  ...
  $.each(JSON.parse(shiftReport_comments), function (index, value) {
    var html = "<tr class='itemComments'>" + "<td><input id='comments[]' value='" + value.comments + "' name='comments[]' type='text' class='form-control form-control-sm' required></td>" + "<input type='hidden' name='comments_id[]' id='comments_id[]' value='" + value.id + "'>" + "<td>" +
...
module.exports = __webpack_require__(/*! C:\laragon\www\aero1\resources\js\Jquery\modules\shiftReport\shiftReportUpdate.js */"./resources/js/Jquery/modules/shiftReport/shiftReportUpdate.js");

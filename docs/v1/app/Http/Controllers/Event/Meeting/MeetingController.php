...
class MeetingController extends Controller
{
  ...
  public function attachSubject(Request $request)
  {
    ...
    if ($request->origin == 'meeting_new_subjects') {
      $attach->meeting_new_subject_id = $request->subject_id;
    } else if ($request->origin == 'meeting_subjects') {
    ...
    if ($request->origin == 'meeting_new_subjects') {
      $attaches = MeetingSubjectAttach::where('meeting_new_subject_id', $request->subject_id)->get();
    } else if ($request->origin == 'meeting_subjects') {
   ...
   */
  public function loadAttachSubject($subject_id ,$origin)
  {
   
    if ($origin == 'meeting_new_subjects') {
      $attaches = MeetingSubjectAttach::where('meeting_new_subject_id', $subject_id)->get();
    } else if ($origin == 'meeting_subjects') {
  ...
  public function deleteAttachSubject($attach_id)
  {
    ...
    if($attach->meeting_subject_id){
      $meeting_subject_id = $attach->meeting_subject_id;
    }else{
      $meeting_subject_id = $attach->meeting_new_subject_id;
    }
    ...
    if($attach->meeting_subject_id){
      ...
      $attachs = MeetingSubjectAttach::where('meeting_new_subject_id', $meeting_subject_id)->get();
    }

...
class CheckSuitesController extends Controller
{
  ...
  function dataExport(){
    ...
    //se nao tiver filtro, limita me 2000 registros
    if ($local ==null && $user == null && $date_start == null && $date_end == null && $maid == null) {
      $checkSuites->limit(2000);
    }


    return $checkSuites->get();

...
Toda consulta de negócio deve receber a empresa da sessão, nunca do corpo enviado pelo cliente. Testes cross-tenant são obrigatórios. RLS só será adotado após o PostgreSQL e não substitui filtros de aplicação e autorização.

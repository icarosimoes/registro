...
$(function () {
  ...
  let inspection_suite_items = $('#inspection_suite_items').val();
            ...
            <tr>
               ...
               <td>
                <select  data-index="${index}" data-coluna="valuation" class="form-control form-control-sm inspection_item" >
                   <option value="sim" ${item.valuation === 'sim' ? 'selected' : ''}>SIM</option>
                   <option value="nao" ${item.valuation === 'nao' ? 'selected' : ''}>NÃO</option>
                </select>
               </td>
               <td><input type="text" class="inspection_item form-control form-control-sm" data-index="${index}" data-coluna="register" value="${item.register}" ></td>
               <td class="">

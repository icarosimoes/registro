    ...
    <div class="row justify-content-center">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('sector.index') }}">Lista de Locais</a></li>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="sector" id="name" value="{{ $local->name }}"placeholder="" required>
                                            <input type="hidden"  id="local_id" value="{{ $local->id }}" >
                                        </div>
                                    </div>
...
@section('plugins.scriptUpdateLocal', true)
@endsection

  ...
  <div class="row justify-content-center">
        <div class="col-sm-12">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Editar Peril</li>
                      ...
                      <form name="formUserEdit" id="formUserEdit" enctype="multipart/form-data" method="POST">
                        <div class="card-body">
                          <div class="form-group">
                            ...
                            <input type="hidden" id="userId" name="userId" value="{{$data['id']}}">
                            <input type="hidden" id="profile" name="profile" value="{{$data['role_id']}}">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label>Perfil:</label>
                            <p class="btn btn-default btn-block">{{ $data['role']->name }}</p>
                          </div>
...
@section('plugins.scriptEditUserProfile', true)
@endsection

        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2">
                            <form name="formAccountEdit" id="formAccountEdit" enctype="multipart/form-data" method="POST">
                                @csrf
                                <!-- {{ csrf_field() }} -->
                        </div> <!-- col-md3 -->
                        <div class="col-md-8">
                            <div class="card card-secondary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="far fa-file"></i> Editar Conta</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ number_format($data->balance, 2, ',','.') }}"
                                            name="balance" id="balance" placeholder="" required>
                                    </div>

  ...
  <div class="row justify-content-center">
      ...
      <div class="col-md-12">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                  <form name="formGroupProduct" id="formGroupProduct" enctype="multipart/form-data" method="POST">
                    @csrf <!-- {{ csrf_field() }} -->
                </div> <!-- col-md3 -->
                <div class="col-md-8">
                            ...
                            <div class="row">
                              <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="3" minlength="3" name="code" id="code" placeholder="" required>

        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2">
                            <form name="formContactsEdit" id="formContactsEdit" enctype="multipart/form-data" method="POST">
                                @csrf
                                <!-- {{ csrf_field() }} -->
                        </div> <!-- col-md3 -->
                        <div class="col-md-8">
                            <div class="card card-secondary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="far fa-file"></i> Editar Contato</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="occupation"
                                            value="{{ $data['occupation'] }}" id="occupation" placeholder="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="Name">Telephone:</label>
                                        <input type="text" class="form-control" name="telephone"
                                            value="{{ $data['telephone'] }}" id="telephone" placeholder="" required>
                                    </div>
                                    <div class="form-group">

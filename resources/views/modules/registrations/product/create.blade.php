...
@section('plugins.JqueryGlobalize', true)
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><i class="fas fa-file-alt"></i> Novo Produto</li>
            ...
            <div class="col-md-12">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2">
                            <form name="formProduct" id="formProduct" enctype="multipart/form-data" method="POST">
                                @csrf
                                <!-- {{ csrf_field() }} -->
                        </div> <!-- col-md3 -->
                        <div class="col-md-12">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" maxlength="7" minlength="7"
                                                    name="code" id="code" value="{{ $group_product->code }}" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <div
                                            ...
                                            <label class="custom-control-label" for="customSwitch3">Adicionar
                                                Insumos?</label>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <div
                                            ...
                                            <label class="custom-control-label" for="customSwitch4">Adicionar
                                                Produtos?</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card card-default" style="display:none" id="add_inputs">
                                <div class="card-header">
                            ...
                            {{--############################## START CARD-PRODUTOS
                            #############################--}}
                            <div class="card card-default" style="display:none" id="add_products">
                                <div class="card-header">
                                ...
                                <div class="card-body" id="dep_product">
                                    ...
                                    {{-- <div
                                        class="row with-border mailbox-controls dep_fc_product">
                                        <div class="col-sm-1">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="costs_sale_price" id="costs_sale_price"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="costs_unit_cost" id="costs_unit_cost"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="costs_contribution_margin_real"
                                                    id="costs_contribution_margin_real" class="form-control" disabled
                                                    required>
                                                </div>
                                                
                                                <input type="hidden" name="costs_contribution_margin_percent"
...
@section('plugins.scriptCreateProduct', true)
@endsection

            ...
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('list.contract.recurrent') }}">Lista de Contratos
                            Recorrentes</a></li>
                    <li class="breadcrumb-item active">Visualizar Contrato Recorrente</li>
                ...
                <div class="container-fluid">
                    <div class="card card-secondary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Visualizar Contrato Recorrente</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                            ...
                            <tbody>
                                @foreach ($installments as $installment)
                                    <tr>
                                        ...
                                        <td>{{ (new DateTime($installment->due_date))->format("d/m/Y") }}</td>
                                        <td>
                                            <a href="{{ route('recurrents.installments.download',['id' => $installment->id]) }}" class="btn btn-sm btn-default"><i class="fas fa-download"></i>
                                                Anexo</a>
                                        </td>
                                    </tr>
                                    @endforeach

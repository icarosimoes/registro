...
@section('plugins.Select2', true)
            ...
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="{{ route('list.contract.recurrent.instament', ['id' => $contract_specificPurpose->id]) }}">Lista
                            de Contratos
                            Recorrentes</a></li>
                        ...
                        <form name="formCommitment" id="formCommitment" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="contract_specific_purposes_id" id="contract_specific_purposes_id" value="{{ $contract_specificPurpose->id }}">
                                </div>
                                <div class="form-group">
    ...
    @section('plugins.scriptCommitmentContractSpecificPurposeInstallments', true)
@endsection

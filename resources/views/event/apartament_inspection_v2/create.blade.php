                    ...
                    <div class="col-md-12">
                        <div class="card card-secondary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Nova Vistoria v2</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="inspected_by" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="d-flex align-items-center">
                                            <select class="form-control" id="type_unit" name="type_unit">
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" required class="ml-5" name="status_conf"
                                                id="status2" value="bloqueado">
        ...
        <div class="modal-content">
            ...
            <form name="formFileDownload" id="formFileDownload" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" id="btn_send_attach" class="btn btn-secondary"><i
                            class="fas fa-save"></i>
                        Save</button>
                </div>
            </form>
...
@section('plugins.scriptCreateApartmentInspectV2', true)
@endsection

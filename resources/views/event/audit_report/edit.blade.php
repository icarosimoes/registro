        ...
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('audit_report.index') }}">Lista de Relatório de
                        Auditoria</a></li>
                <li class="breadcrumb-item active">Editar Relatório de Auditoria</li>
            </ol>
        </div>
        <div class="col-md-12">
                ...
                <form name="formShiftReport" id="formShiftReport" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control mask_integer" value="{{ $auditReport->average_daily }}" name="diaria_medias" id="average_daily" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="Name">Hóspedes:</label>
                                        <input type="text" class="form-control mask_integer" value="{{ $auditReport->guests }}" name="inputQuantity" id="guests">
                                    </div>
                                    <div class="col">
                                        <label for="Name">UH'S:</label>
                                        <input class="form-control mask_integer" value="{{ $auditReport->uh }}" type="text" name="uhs" id="uh">
                                    </div>
                                    <div class="col">
                                        <label for="Name">Manutenção:</label>
                                        <input type="text" class="form-control mask_integer" value="{{ $auditReport->maintenance_apartment }}" name="manutencao" id="maintenance_apartment">
                                    </div>
                                    <div class="col">
                                        <label for="Name">Limpeza:</label>
                                        <input type="text" class="form-control mask_integer" value="{{ $auditReport->cleaning }}" name="limpeza" id="cleaning">
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-secondary card-outline">
                            ...
                            <div style="cursor:poiter" class="card-footer text-center" id="addTable1">
                                <i class="far fa-plus-square"></i>&nbsp;&nbsp;<a href="javascript:">Adicionar Novo
                                    Item</a>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <button type="button" id="btn_save" class="btn btn-success float-right"><i class="far fa-save"></i>&nbsp;&nbsp;Salvar</button>
                        </div>
...
@section('plugins.scriptAuditReportUpdate', true)
@endsection

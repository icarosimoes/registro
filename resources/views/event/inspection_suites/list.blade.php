        ...
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Lista de vistorias de suítes</li>
                </ol>
            </div>
            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col text-left">
                                    <a type="button" href="{{ route('inspection_suite.create') }}" data-toggle="tooltip"
                                        data-placement="top" title="Nova Vistoria"
                                        ...
                                        {{-- @foreach ($roles as $role) --}}
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group-sm">
                                                    ...
                                                    'view.client') --}}
                                                    <a href="{{ route('inspection_suite.show', [$item->id]) }}"
                                                    ...
                                                    {{-- @can('checkRouters', $route =
                                                    'edit.client') --}}
                                                    <a href="{{ route('inspection_suite.edit', [$item->id]) }}"

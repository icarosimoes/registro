        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-12">
                ...
                <div class="container-fluid">
                    <!-- form start -->
                    <form name="formMeeting" id="formMeeting" enctype="multipart/form-data" method="POST">
                        <div class="col-sm-12">
                            ...
                            <div class="card card-secondary card-outline">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="card-body">
                                            <div class="row" id="registered_users"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="card-body">
                                            <div class="row" id="invited_users"></div>
                                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card card-secondary card-outline">
                                ...
                                <div class="card-body">
                                    <div class="card-body table-responsive p-0">
                                        <div id="divRowtopics_covered" class="row"></div>
                                    </div>
                                </div>
                                <div class="card-footer text-center">
            ...
            <!-- Modal selecionar ocorrência(Registro)-->
...
@section('plugins.scriptCreateMeeting', true)
@endsection
